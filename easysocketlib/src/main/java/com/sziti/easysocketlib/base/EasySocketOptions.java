 ...
 */
public class EasySocketOptions implements IIOCoreOptions {
    /**
     * 框架是否是调试模式
     */
    ...
    public static class Builder {
        private EasySocketOptions mOptions;

        public Builder() {
            this(EasySocketOptions.getDefault());
        }
        ...
        public Builder(EasySocketOptions okOptions) {
            mOptions = okOptions;
        }
