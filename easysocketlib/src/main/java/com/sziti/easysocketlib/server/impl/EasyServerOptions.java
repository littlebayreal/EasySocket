...
import com.sziti.easysocketlib.protocol.DefaultNormalReaderProtocol;

import java.nio.ByteOrder;

public class EasyServerOptions implements IIOCoreOptions {
    ...
    private EasyServerOptions() {
    }

    public static void setIsDebug(boolean isDebug) {
        EasyServerOptions.isDebug = isDebug;
    }

    public static EasyServerOptions getDefault() {
        EasyServerOptions okOptions = new EasyServerOptions();
    ...
    public static class Builder {
        ...
        public Builder(EasyServerOptions options) {
            EasyServerOptions clone = new EasyServerOptions();
        ...
        public EasyServerOptions build() {
            return mOptions;
        }
    }
