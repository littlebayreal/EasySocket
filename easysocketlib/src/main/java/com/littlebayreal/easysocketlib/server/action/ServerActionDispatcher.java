...
import static com.littlebayreal.easysocketlib.server.action.IAction.Server.ACTION_CLIENT_CONNECTED;
import static com.littlebayreal.easysocketlib.server.action.IAction.Server.ACTION_CLIENT_DISCONNECTED;
import static com.littlebayreal.easysocketlib.server.action.IAction.Server.ACTION_SERVER_ALLREADY_SHUTDOWN;
import static com.littlebayreal.easysocketlib.server.action.IAction.Server.ACTION_SERVER_LISTENING;
import static com.littlebayreal.easysocketlib.server.action.IAction.Server.ACTION_SERVER_WILL_BE_SHUTDOWN;
